...
<head>
   ...
   <title>FLC Models &amp; Talents - PHOTOGRAPHER </title>
...
<body>
   ...
   <?php /*?> <div id="slideshow">
      <img src="../image/cam_theme.png" class="bgM" /> 
    </div><?php */?>
    ...
    <div class="container inner_content">
        ...
        <script type="text/javascript">
			...
			function pagin2(obj){
				$("#pagin_form2").attr("action","photographer.php?page="+obj)
				$("#pagin_form2").submit();
			}
		</script>
        <!-- Title -->
        	...
        	<div class="col-lg-7 col-xs-12">
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group">
                        <label for="inputName" class="col-xs-4 col-sm-2 text-left">Name:</label>
                    ...
                    <div class="form-group">
                         <label for="categories" class="col-xs-4 col-sm-2 text-left">Categories:</label>
                        <div class="col-xs-8 col-sm-5">
