...
*/
    ...
    private function loginWithPostData() {
		...
		$checklogin = $this->db_connection->query("SELECT user_id,user_name, user_email, user_pass, user_role FROM fdl_bookers_gin WHERE (user_name = '".$this->user_name."' or user_email = '".$this->user_name."') && user_role > 2");
