...
<head>
   ...
   <title>FLC Models &amp; Talents - Hostess </title>
...
<body>
    ...
    <div class="container inner_content">
        ...
        <script type="text/javascript">
			...
			function pagin2(obj){
				$("#pagin_form2").attr("action","hostess.php?page="+obj)
				$("#pagin_form2").submit();
			}
		</script>
        <!-- Title -->
        	...
        	<div class="col-lg-7 col-xs-12">
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                        <select name="language[]" id="inputLang" multiple="multiple" class="select2" style="width:100%" data-placeholder="Select Language">
                        	 <?php
                            ...
                            ?>
                            	<option value="<?php echo $row->Native_Language; ?>" >
								<?php echo $row->Native_Language; ?>
                                </option>
                            <?php
										/*if($k%6==0){
											echo '</div><div class="col-sm-12">';
