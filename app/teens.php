...
<head>
   ...
   <title>FLC Models &amp; Talents - Teens </title>
...
<body>
   ...
   <?php /*?> <div id="slideshow">
      <img src="../image/teen_theme.png" class="bgM" /> 
    </div><?php */?>
    ...
    <div class="container inner_content">
		<header class="hero-spacer">
        	<div class="main_title">
                 <?php /*?><a class="text_none" href="teens.php"><span class="title-grey">TEENS &gt;</span></a><?php */?>
                 TEENS
            </div>
        ...
        <script type="text/javascript">
			...
			function pagin2(obj){
				$("#pagin_form2").attr("action","teens.php?page="+obj)
				$("#pagin_form2").submit();
			}
		</script>
        <!-- Title -->
