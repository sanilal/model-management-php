...
<div class="nav_container">
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"> <img alt="FLC Logo" title="FLC Models" src="images/flc-logo-new.jpg" class="img-responsive" /></a>
            <?php 
			...
			?>
             <?php /*?><a href="notification.php?v=1.1" style="float:right" class="badge2" <?php if($n_cnt->not_count > 0){ echo 'data-badge="'.$n_cnt->not_count.'"';} ?> ><img src="images/notify-ico.png" /></a><?php */?>
        </div>
