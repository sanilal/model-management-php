...
<head>
   ...
   <title>FLC Models &amp; Talents - Men </title>
           ...
           <div class="row content-main" style="padding-bottom:20px"> 
				...
				<div class="container" style="padding: 0px 10px;">
				  ...
				  while($row=$model_res_inter->fetch_object()){
					  ?>
					 <div class="col-xs-4">
					  	<a href="profile.php?res_id=<?php echo $row->Resource_ID; ?>&type=men" class="bwWrapper"  >
						  ...
						  $img_code='<img src="'.$opt_img_path.'" class="grayscale img-responsive" alt="FLC Models & Talents - Men" />';
						...
						<div class="absl_div"> 
                        	<div class="absl_name">
                            	<?php /*?><img width="25" alt="FLC Models &amp; Talents" class="grayscale" src="../images/flc_mark.jpg" style=" position:absolute; left:0; bottom:0;"> <?php */?>
...
<div class="col-xs-3">
        <a href="women.php">
            <?php /*?><i class="fa fa-home " ></i><?php */?> WOMEN
        </a>
    </div>
<div class="col-xs-7">
<div class="row">
