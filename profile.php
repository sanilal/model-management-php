...
<html lang="en">
  <head>
  <title>FLC Production & Model Management- Model Profile </title>
  ...
  <body>
    ...
    if(isset($_REQUEST['type'])){
					 if($_REQUEST['type']=="model"){
               		...
               		echo '&lt; <a style="text-decoration:none" href="'.$_REQUEST['type'].'.php"><span class="title-grey" style=""> Back to <span style="text-transform:capitalize;">'.$_REQUEST['type'].'</span> </span></a>';
				 } 
?>
<h2 style="text-align:center"><?php echo $row->First_Name; ?> &nbsp; <span class="title-grey">(<?php echo $row->Resource_ID ?>)</span></h2>
  ...
  <div class="shortlist">
       ...
       <style type="text/css">
                 .cart_content{float: right; margin-top: -70px}
                </style>
        </div>
