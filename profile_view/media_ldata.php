            ...
            <?php
                ...
                <div style="text-align:left; color:#666; padding-left:10px; font-size:16px; width:955px; overflow:hidden" class="gallery-wrap" >
                    ...
                    <?php
							...
							$opt_img_path="../app/image.php?img=".urlencode("../".$img_path);
							if($row->work_image!="") {
					?>
					...
					$opt_img_path2="../app/image.php?img=".urlencode("../".$img_path2);
							if($row->work_image2!="") {
					?>
                            <div class="model_thumbs gallery__item"> 
                            	
                              		
                                    <img src="<?php echo $opt_img_path2; ?>" /> 
                               
                            </div>
                        
                    <?php } 
						$img_path3="uploads/".$row->work_image3;
						$opt_img_path3="../app/image.php?img=".urlencode("../".$img_path3);
							if($row->work_image3!="") {
					?>
                            <div class="model_thumbs gallery__item"> 
                            	
                              		
                                    <img src="<?php echo $opt_img_path3; ?>" /> 
                               
                            </div>
                        
                    <?php } 
						$img_path4="uploads/".$row->work_image4;
						$opt_img_path4="../app/image.php?img=".urlencode("../".$img_path4);
							if($row->work_image4!="") {
					?>
                            <div class="model_thumbs gallery__item"> 
                            	
                              		
                                    <img src="<?php echo $opt_img_path4; ?>" /> 
                               
                            </div>
                        
                    <?php } 
						$img_path5="uploads/".$row->work_image5;
						$opt_img_path5="../app/image.php?img=".urlencode("../".$img_path5);
							if($row->work_image5!="") {
					?>
                            <div class="model_thumbs gallery__item"> 
                            	
                              		
                                    <img src="<?php echo $opt_img_path5; ?>" /> 
                               
                            </div>
                        
                    <?php } 
						$img_path6="uploads/".$row->work_image6;
						$opt_img_path6="../app/image.php?img=".urlencode("../".$img_path6);
							if($row->work_image6!="") {
					?>
                            <div class="model_thumbs gallery__item"> 
                            	
                              		
                                    <img src="<?php echo $opt_img_path6; ?>" /> 
                               
                            </div>
                        
                    <?php } 
						$img_path7="uploads/".$row->work_image7;
						$opt_img_path7="../app/image.php?img=".urlencode("../".$img_path7);
							if($row->work_image7!="") {
					?>
                            <div class="model_thumbs gallery__item"> 
                            	
                              		
                                    <img src="<?php echo $opt_img_path7; ?>" /> 
                               
                            </div>
                        
                    <?php } 
						$img_path8="uploads/".$row->work_image8;
						$opt_img_path8="../app/image.php?img=".urlencode("../".$img_path8);
							if($row->work_image8!="") {
					?>
                            <div class="model_thumbs gallery__item"> 
                            	
                              		
                                    <img src="<?php echo $opt_img_path8; ?>" /> 
                               
                            </div>
                        
                    <?php } 
						$img_path9="uploads/".$row->work_image9;
						$opt_img_path9="../app/image.php?img=".urlencode("../".$img_path9);
							if($row->work_image9!="") {
					?>
                            <div class="model_thumbs gallery__item"> 
                            	
                              		
                                    <img src="<?php echo $opt_img_path9; ?>" /> 
                               
                            </div>
                        
                    <?php } 
						$img_path10="uploads/".$row->work_image10;
						$opt_img_path10="../app/image.php?img=".urlencode("../".$img_path10);
							if($row->work_image10!="") {
					?>
                            <div class="model_thumbs gallery__item"> 
                            	
                              		
                                    <img src="<?php echo $opt_img_path10; ?>" /> 
