    ...
    <div class="container inner_content">
       ...
       <!-- <hr>-->
				 ...
				 <div class="col-lg-12">
				  ...
				  while($row=$model_res->fetch_object()){
					 ...
					 <div class="col-sm-15 col-xs-6">
						  ...
						  $img_code='<img src="'.image_path.$sub_folder.'/'.$row->Resource_ID.'_01.jpeg" class="grayscale img-responsive" alt="FLC Models & Talents - Stylist" />';
        ...
        <div class="row content-main">   
            ...
            <div class="col-sm-5">
            	 <img src="image/stylist_theme.png" style="width:100%" alt="FLC Models & Talents - Sylists"/>
            </div>
        </div>
       <?php } ?>
    </div>
