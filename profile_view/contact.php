       ...
       <!-- <hr>-->
        ...
        <div class="row content-main">
            ...
            <div class="col-sm-7">
                ...
                <a href="images/flc_location_map.jpg" download="flc_location_map.jpg" style="float:right; text-decoration:none" target="_blank">
                	<img src="image/download_icon.png" style="border:none" width="123" height="20" alt="FLC Models & Talents - download map"  />
                </a>
                <br /><br />
             	<img src="images/flc_location_map.jpg" alt="FLC Models & Talents - Location map" style="display:inline" class="about_theme" />
            </div>
