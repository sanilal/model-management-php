...
<head>
    ...
    <title>FLC Models &amp; Talents - Teen Search</title>
    ...
    <div class="container inner_content">
       ...
       <!-- <hr>-->
				 ...
				 <div class="col-lg-12">
				  ...
				  while($row=$model_res->fetch_object()){
					 ...
					 <div class="col-sm-15 col-xs-6">
						  ...
						  $img_code='<img src="'.image_path.$sub_folder.'/'.$row->Resource_ID.'_01.jpeg" class="grayscale img-responsive" alt="FLC Models & Talents - Teens" />';
        ...
        <div class="row content-main">   
            ...
            <div class="col-sm-5">
            	 <img src="image/teen_theme.png" style="width:59%" alt="FLC Models & Talents- teen search"/>
            </div>
        </div>
       <?php } ?>
    </div>
