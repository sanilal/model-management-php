...
<body>  
 ...
 <select style="background: none;border: none;" name="cont_code">
...
<option data-countrycode="CY" value="+90392">+90392</option>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-8">
                 <div class="input-group">
                 <span class="input-group-addon">
 <select style="background: none;border: none;" name="what_code">
<option data-countrycode="AE" value="+971">+971</option>
<option data-countrycode="US" value="+1">+1</option>
<option data-countrycode="UZ" value="+7">+7</option>
<option data-countrycode="EG" value="+20">+20</option>
...
<option data-countrycode="CY" value="+90392">+90392</option>
              ...
              <div class="form-group">
               <?php /*?> <label for="inputPhotos" class="col-sm-4 control-label">Attach photos </label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                <div class="col-sm-10">
                  <button type="submit" class="btn btn-default" style="padding-left:30px; padding-right:30px; font-size:16px" id="submit_button">Register</button>
                </div>
              </div>
            </form>
