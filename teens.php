  ...
  <option value="563" style="font-weight: bold;">Amharic</option>
			...
			<h2>AGE RANGE</h2>
			  ...
			  <Select class="form-control" id="inputAge" name="age">
                                ...
                                <option value="13 AND 16" <?php if($age!=NULL && $age=='13 AND 16'){ echo 'selected="selected"';} ?>>13 - 16</option>
                                <option value="17 AND 19" <?php if($age!=NULL && $age=='17 AND 19'){ echo 'selected="selected"';} ?>>17 - 19</option>
