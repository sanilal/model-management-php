...
.crop_button{ position:absolute; left:150px; bottom:0}
.multi-item-carousel{
  .carousel-inner{
    > .item{
          ...
          <div class="box" style="border:0">
			...
			?>
                      ...
                      <div class="item <?php if($img==0){ echo 'active';} ?>">
                        <div class="col-xs-4" style="height:370px; overflow:hidden; margin-bottom:20px;"><img src="../<?php echo $filename; ?>" style="max-height:400px;"  />
                        <a href="javascript:;" onClick="crop_img(this)" rel="<?php echo $model->Mailer_ID; ?>" class="btn btn-warning crop_button"  style="display:none">Crop</a>
                        </div>
                      </div>
