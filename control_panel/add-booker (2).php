...
//
 if(isset($_REQUEST['btnadd'])){
	...
	if($booker!=""){
	  ...
	  //$num=0;
	  if($num < 1){
		  $query = "INSERT INTO `fdl_bookers_gin` (`user_name`,`user_pass`, `user_email`, `user_role`, `signature`, `date_added`) VALUES('$booker','".md5($_POST['password'])."', '".$_POST['email']."', '2', '".$_POST['sign']."', '$cur_date' )";
		  //var_dump($query); exit;
