...
*/
    ...
    private function loginWithPostData() {
		...
		$checklogin = $this->db_connection->query("SELECT user_id,user_name, user_email, user_pass, user_role FROM users WHERE user_name = '".$this->user_name."' or user_email = '".$this->user_name."'");
...
//////////////////////////////
	 public function getUserData($id) {
		...
		$stmt=$this->db_connection->query("SELECT user_id,user_name, user_email,user_role,signature FROM users WHERE user_id=$val");
