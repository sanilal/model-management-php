		...
		init: function() {
			...
			if (el.is(':file')) {
				...
				var fileOutput = function() {
					...
					var file = $('<div' + att.id + ' class="jq-file' + att.classes + '"' + att.title + ' style="display: inline-block; position: relative"></div>'),
						browseFile = $('<div class="jq-file__browse">' + browse + '</div>').appendTo(file),
						name = $('<div class="jq-file__name">' + opt.filePlaceholder + '</div>').appendTo(file);
			...
			// select
				...
				var selectboxOutput = function() {
					...
					var option = $('option', el), list = '';
					// формируем список селекта
					function makeList() {
						for (var i = 0, len = option.length; i < len; i++) {
							var li = '', liClass = '', liClasses = '', dataList = '', optionClass = '', optgroupClass = '', dataJqfsClass = '',
								disabled = 'disabled',
					...
					function doSelect() {
						...
						var selectbox =
							$('<div' + att.id + ' class="jq-selectbox jqselect' + att.classes + '" style="position: relative; z-index:' + singleSelectzIndex + '">' +
						...
						if (divText.is('.placeholder') && (divText.width() > liWidthInner)) {
							...
							var selClone = selectbox.clone().appendTo('body').width('auto'),
								selCloneWidth = selClone.outerWidth();
							selClone.remove();
						...
						.on('focus.styler', function() {
							$('div.jqselect').removeClass('opened dropup dropdown').find('div.jq-selectbox__dropdown').hide();
						})
