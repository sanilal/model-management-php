...
<div class="form-group">
                ...
                <div class="col-4">
                  <select class="form-control required" id="inputHeight" name="height" required>  
                    ...
                    <option value="< 152 cm">Less than 152 cm</option>  
                ...
                <label for="inputWeight" class="col-2 control-label right-label">Weight</label>
                <div class="col-4">
                  <select class="form-control required" id="inputWeight" placeholder="Weight" name="weight" required >
