  ...
  <option value="563" style="font-weight: bold;">Amharic</option>
			...
			<h2>AGE RANGE</h2>
			  ...
			  <Select class="form-control" id="inputAge" name="age">
                                ...
                                <option value="0 AND 3" <?php if($age!=NULL && $age=='0 AND 3'){ echo 'selected="selected"';} ?>>0 - 3</option>
                                <option value="4 AND 7" <?php if($age!=NULL && $age=='4 AND 7'){ echo 'selected="selected"';} ?>>4 - 7</option>
                                <option value="8 AND 12" <?php if($age!=NULL && $age=='8 AND 12'){ echo 'selected="selected"';} ?>>8 - 12</option>
                                <option value="13 AND 19" <?php if($age!=NULL && $age=='13 AND 19'){ echo 'selected="selected"';} ?>>13 - 19</option>
...
<?php */?>	
		...
		<div class="modFilterBox filterCheckboxes" id="filter17">
			...
			$model_res =$models->searchModels($type_title,$gender,$age,$etnicity,$name);
			$total_num = $models-> paginateResult($type_title,$gender,$age,$etnicity,$name);
			 $k=1;
  ...
  <script type="text/javascript">
   ...
   <?php /*?><link rel="stylesheet" href="<?php echo MN_url; ?>control_panel/dist/css/bootstrap-dialog.css">
   <script src="<?php echo MN_url; ?>control_panel/bootstrap/js/bootstrap.min.js"></script>
   <script src="<?php echo MN_url; ?>control_panel/dist/js/bootstrap-dialog.min.js"></script><?php */?>
