...
<html lang="en">
  <head>
  <title>FLC Production & Model Management- Models Men</title>
	...
	<div class="modFilterBox modFiltersSearch">
		...
		<div class="modFilterBox filterCheckboxes" id="filter17">
		  ...
		  require_once(MN_url."classes/Models.php");
			...
			$model_res_inter =$models->searchHost('Model','Male',$age,$etnicity,$name,NULL,"Internationals");
			...
			if($model_res_inter->num_rows>0){
			  ?>
				  ...
				  while($row=$model_res_inter->fetch_object()){
                	...
                	<div class="col-3">
               	    	<div class="models-thumb">
                             <a href="profile.php?res_id=<?php echo $row->Resource_ID; ?>&type=men"  > 
                             <?php 
						  ...
						  $img_code='<img src="'.$opt_img_path.'" class="img-fluid" alt="FLC Models & Talents - Men International Models" />';
                ...
                <?php
					$model_res=$models->searchHost('Model','Male',$age,$etnicity,$name,NULL,"NOTIN");
					if(isset($_POST['name'])){
					$total_num = $models-> paginateHostResult('Model','Male',$age,$etnicity,$name,NULL,"NOTIN",NULL);
					$k=1;
				...
				?>
                	<div class="col-3">
						 ...
						 // var_dump($img_path);
						  //$img_path=image_path.$sub_folder."/".$row->Resource_ID."_01.jpeg";
						  $opt_img_path=MN_url."app/image.php?img=../".$img_path;
						  $img_code='<img src="'.$opt_img_path.'" class="img-fluid" alt="FLC Models & Talents - Men Models" />';
						  if(!file_exists(MN_url.$img_path)) {
							  $img_code='<div class="blank_cont">&nbsp; </div>';
						  }
						  ?>
