                	...
                	<ul class="flc_menu">
                            ...
                            <li class="dropdown"><a href="#" title="FLC MODELS models" class="dropdown-toggle" data-toggle="dropdown">Talents<b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="plus_size.php" title="FLC Plus Size MODEL">Plus Size Models</a></li>
                                    <li><a href="stylist.php" title="FLC Stylist">Stylists</a></li>	
                                    <li><a href="photographer.php" title="FLC Photographer">Photographers</a> </li>
                                </ul>
                            </li>
